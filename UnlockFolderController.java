 ...
 * @author utkarsh.deep
 */
public class UnlockFolderController implements Initializable {
    ...
    @FXML
    private Hyperlink folderNameLink;
    @FXML
    ...
    @FXML
    private void handleUnlockFolderButton(ActionEvent event) throws Exception
    {
        //if(basic.isSelected())
        {
            ...
            FileIsLockedController.msg = "FOLDER IS UNLOCKED";
            Parent root;
